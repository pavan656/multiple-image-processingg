...
def app():
    st.markdown(
    "<h1 style='font-size: 5em;text-align: center; border: solid #2B1B3D; border-radius: 10px;'>IMG Compressor</h1>",
    ...
    st.write(
        """✂️ Welcome to IMG Compressor. Your image compression tool!
        IMG Compressor is a user-friendly web application designed to
